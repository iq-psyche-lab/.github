<h1 align="center">
  <img src="https://api.iconify.design/lucide/brain.svg?color=%23ec4899" width="32" align="center"/>
  IQ Psyche Lab
</h1>
...
[![IQ Psyche Lab](https://img.shields.io/badge/IQ_Psyche_Lab-iq--psyche--lab.github.io-ec4899?style=for-the-badge&logo=gitbook&logoColor=white)](https://iq-psyche-lab.github.io)
...
대중 심리학과 뇌 다큐멘터리는 보통 신기한 현상을 보여주는 데서 멈춥니다.  
이 연구소는 한 걸음 더 들어갑니다 — 뉴런과 계산이라는 가장 단단한 바닥에서 출발해  
지각·기억·감정이 *어떻게* 만들어지는지 분해하고, 실험으로 그게 틀릴 수 있는지 시험하고,  
한 층씩 쌓아 올려 마침내 *경험하는 나 자신*까지 설명을 밀어붙입니다.

그리고 설명이 끝내 닿지 못하는 지점 — **왜 거기에 '느낌'이 있는가** — 을 지우지 않고 정직하게 표시합니다.

그래서 모든 글은 같은 흐름으로 끝납니다 —
**메커니즘**(3인칭, 어떻게 작동하나) → **간극**(1인칭을 어디서 놓치나) → **경험**(그래서 느껴지는 것은 무엇인가).
...
아리스토텔레스는 지적 덕(intellectual virtue)을 다섯으로 나눴습니다 — Techne · Episteme · Phronesis · Nous · Sophia. 앞의 네 연구소가 그 덕들로 *세계를 바깥으로* 바라본다면(제작·증명·판단·환원), 이 다섯 번째 연구소는 방향을 **안으로** 돌립니다.

왜냐하면 그 모든 덕은 결국 *마음(ψυχή)의 능력*이기 때문입니다. 아리스토텔레스의 『영혼에 관하여』(De Anima, *Περὶ Ψυχῆς*)는 *무엇을 아는가*가 아니라 **아는 자 그 자체**를 다룹니다. Psyche Lab은 그 반성적 전환 — 앎이 마침내 *자기 자신의 자리*를 되돌아보는 곳입니다.
...
> 마음은 셋의 대질로 검증합니다 — **실험**(3인칭 측정) · **현상학**(1인칭 기술) · **계산 모델**(만들어 재현). 그리고 그 셋이 *끝내 합치되지 않는 간극*을 지우지 않는 것이 이 연구소의 규율입니다.
>
> Sophia(Physis Lab)가 *세계가 무엇으로 이루어졌는지*를 관찰자 앞에서 멈춰 재구성했다면, Psyche Lab은 바로 그 **관찰자**를 엽니다. 두 연구소는 같은 솔기의 양쪽 — 한쪽은 *우주*를, 다른 쪽은 *우주를 보는 눈*을 다룹니다.

---

## 🗺️ Architecture — 7-Layer Stack

이 연구소는 분과를 나열하지 않고 **마음의 의존성(추상화 층위)** 으로 쌓습니다. 맨 아래 Layer 0의 사고 언어가 위의 모든 레이어에서 다시 쓰이고,
같은 본질 원리(**표상 · 예측 · 통합 · 자기참조 · 체화 · 창발**)가 레이어를 가로질러 반복됩니다.

가장 아래 *물리적 바닥*(뉴런)에서 출발해, 한 층씩 창발시켜 *맨 위의 자아*까지 — 이것이 **"마음을 바닥부터"** 의 진짜 의미입니다.
...
### 🧠 Layer 0 — Language of Mind &nbsp;<sub>마음을 탐구하는 자의 모국어</sub>

<details>
<summary>&nbsp;🧠 &nbsp;<b>Language of Mind</b> &nbsp;&nbsp;<img src="https://img.shields.io/badge/5_repos-e8f4f8?style=flat-square&color=ef6c00"/></summary>
...
### ⚡ Layer 1 — Neural Substrate &nbsp;<sub>뇌라는 물리 시스템: 환원의 가장 단단한 바닥</sub>

<details>
<summary>&nbsp;⚡ &nbsp;<b>Neural Substrate</b> &nbsp;&nbsp;<img src="https://img.shields.io/badge/4_repos-e8f4f8?style=flat-square&color=2e7d32"/></summary>
...
### 💭 Layer 2 — Cognition &nbsp;<sub>마음의 알고리즘: 지각 · 주의 · 기억 · 학습 · 언어 · 감정</sub>

<details>
<summary>&nbsp;💭 &nbsp;<b>Cognition</b> &nbsp;&nbsp;<img src="https://img.shields.io/badge/6_repos-e8f4f8?style=flat-square&color=1565c0"/></summary>
...
### 🧩 Layer 3 — The Computational Mind &nbsp;<sub>마음 = 계산? 가장 강력한 가설과 그 반론</sub>

<details>
<summary>&nbsp;🧩 &nbsp;<b>The Computational Mind</b> &nbsp;&nbsp;<img src="https://img.shields.io/badge/3_repos-e8f4f8?style=flat-square&color=283593"/></summary>
...
### 🌌 Layer 4 — Consciousness &nbsp;<sub>환원이 가장 거세게 저항하는 곳: 이 연구소의 정점</sub>

<details>
<summary>&nbsp;🌌 &nbsp;<b>Consciousness</b> &nbsp;&nbsp;<img src="https://img.shields.io/badge/4_repos-e8f4f8?style=flat-square&color=5e35b1"/></summary>
...
### 🪞 Layer 5 — The Self &nbsp;<sub>이 모든 걸 아는 '나': 물질에서 마음으로의 정점</sub>

<details>
<summary>&nbsp;🪞 &nbsp;<b>The Self</b> &nbsp;&nbsp;<img src="https://img.shields.io/badge/4_repos-e8f4f8?style=flat-square&color=ad1457"/></summary>
...
### 🧬 Layer 6 — Synthesis &nbsp;<sub>층을 가로지르는 본질 — 이 연구소의 무기</sub>

<details>
<summary>&nbsp;🧬 &nbsp;<b>Synthesis</b> &nbsp;&nbsp;<img src="https://img.shields.io/badge/5_repos-e8f4f8?style=flat-square&color=7b1fa2"/></summary>
...
<br/>
<sub>💡 지속적으로 새로운 탐구 프로젝트가 추가될 예정입니다. (총 31 repos)</sub>
...
<sub>본문 10섹션 템플릿: 🎯 질문 · 🌍 어디서 마주치나 · 🔍 직관의 함정(통념·뇌 미신) · ⚙️ 3인칭 메커니즘 · 🧪 증거(실험·병변·정신물리) · 🌉 설명적 간극(1인칭이 어디서 빠지나) · 🧬 횡단 원리(표상·예측·통합·자기참조·창발) · 🪞 1인칭(현상학적으로 어떻게 경험되나) · 📐 예측·반증 · 🤔 다음 질문</sub>
